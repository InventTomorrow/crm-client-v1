      ...
      <Container>
        <div className="grid lg:grid-cols-[1fr_1.15fr] gap-14 items-center">
          <div>
            ...
            <Reveal delay={0.1}>
              <p className="mt-6 text-brand-text text-[16px] leading-relaxed max-w-md">
                Stop switching between phones, tabs, and team members. AsaanRabta
                gives your team one shared workspace to view customer chats,
                reply faster, and take over from AI whenever needed.
              </p>
            </Reveal>
            <Reveal delay={0.2}>
