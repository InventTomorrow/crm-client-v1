...
export const ORDER_STATUS_META: Record<OrderStatus, StatusMeta> = {
  ...
  PROCESSING: { label: 'Processing', cls: 'bg-[#CFFAFE] text-[#155E75]', dot: 'bg-[#0891B2]' },
  SHIPPED: { label: 'Shipped', cls: 'bg-[#E0E7FF] text-[#3730A3]', dot: 'bg-[#4F46E5]' },
  OUT_FOR_DELIVERY: { label: 'Out for delivery', cls: 'bg-[#EDE9FE] text-[#5B21B6]', dot: 'bg-[#7C3AED]' },
  DELIVERED: { label: 'Delivered', cls: 'bg-[#D1FAE5] text-[#065F46]', dot: 'bg-[#059669]' },
