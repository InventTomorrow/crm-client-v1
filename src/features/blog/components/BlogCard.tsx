...
import { blogPostPath, coverGradient, formatPublishedDate } from "../blog.utils";
      ...
      >
        ...
        <div className="flex flex-1 flex-col p-5 sm:p-6">
          <div className="flex items-center gap-2 text-[12px] font-medium text-brand-green">
            ...
            <span className="text-brand-text-soft">{post.readingMinutes} min read</span>
          </div>
          ...
          <div className="mt-5 flex items-center gap-2 border-t border-brand-mint-2 pt-4 text-[13px] text-brand-text-soft">
            <span className="font-medium text-brand-dark/70">{post.authorName}</span>
            {post.publishedAt && (
              <>
