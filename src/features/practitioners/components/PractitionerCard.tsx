...
export const VISIBILITY_CHIP_CLASS: Record<PractitionerVisibility, string> = {
  BOOKABLE:
    "border border-[var(--accent)]/30 bg-[var(--surface)] text-[var(--accent)]",
  LISTED:
...
export function PractitionerCard({
  ...
  return (
    <article
      className={cn(
        "flex h-full flex-col overflow-hidden rounded-[var(--radius-card)] border border-[var(--accent)]/30 bg-[var(--surface)] shadow-[var(--shadow-1)] transition-[border-color,box-shadow] hover:border-[var(--accent)]/60 hover:shadow-[var(--shadow-2)]",
    ...
    >
      ...
      <header className="flex items-start gap-3 border-b border-[var(--accent)]/30 bg-[var(--accent-soft)] px-4 py-3">
        ...
        <Avatar className="size-11 shrink-0">
          ...
          <AvatarFallback className="border border-[var(--accent)]/30 bg-[var(--surface)] text-[var(--accent)]">
