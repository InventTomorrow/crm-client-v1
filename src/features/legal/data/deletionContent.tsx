...
export const DELETION_SECTIONS: LegalSection[] = [
  {
    ...
    content: (
      <div className="space-y-3">
        ...
        <div className="p-3.5 bg-brand-mint-soft rounded-xl border border-brand-green/20 text-sm text-brand-dark flex items-start gap-2.5">
  ...
  },
  {
    ...
    content: (
      <div className="space-y-3">
        ...
        <p className="text-sm text-brand-text italic pt-1">
  ...
  },
  {
    ...
    content: (
      <div className="space-y-3">
        ...
        <div className="p-4 bg-brand-mint-soft/50 rounded-xl border border-brand-green/30 space-y-2 text-sm">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pt-1">
          <div className="p-3 bg-gray-50 rounded-xl border border-gray-200">
            <span className="text-sm font-mono font-bold text-brand-green">STAGE 1</span>
            <h4 className="font-bold text-brand-dark text-sm mt-1 mb-1">Immediate Disconnection (0-24 Hours)</h4>
            <p className="text-sm text-brand-text">WhatsApp QR session keys, access tokens, and active logins are revoked immediately.</p>
          </div>
          <div className="p-3 bg-gray-50 rounded-xl border border-gray-200">
            <span className="text-sm font-mono font-bold text-brand-green">STAGE 2</span>
            <h4 className="font-bold text-brand-dark text-sm mt-1 mb-1">Database Soft Purge (1-7 Days)</h4>
            <p className="text-sm text-brand-text">Leads, message logs, AI chat history, and customer records are anonymized and removed from active CRM databases.</p>
          </div>
          <div className="p-3 bg-gray-50 rounded-xl border border-gray-200">
            <span className="text-sm font-mono font-bold text-brand-green">STAGE 3</span>
            <h4 className="font-bold text-brand-dark text-sm mt-1 mb-1">Complete Backup Purge (30 Days)</h4>
            <p className="text-sm text-brand-text">Encrypted system backups rotate and permanently erase all residual encrypted fragments.</p>
          </div>
        </div>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-3">
        ...
        <ul className="list-disc pl-5 space-y-1.5 text-sm text-brand-text">
        ...
        <p className="text-sm text-brand-text pt-1">
