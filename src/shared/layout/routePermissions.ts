...
const ROUTE_PERMISSIONS: { prefix: string; permission: string }[] = [
  ...
  { prefix: "/service-orders", permission: "orders:view" },
  { prefix: "/inventory", permission: "inventory:view" },
  { prefix: "/menu", permission: "inventory:view" },
  { prefix: "/services", permission: "services:view" },
  { prefix: "/clinical-services", permission: "clinical_services:view" },
  { prefix: "/practitioners", permission: "practitioners:view" },
  { prefix: "/coverage-areas", permission: "clinic_coverage:view" },
...
const ROUTE_CAPABILITIES: { prefix: string; capability: VerticalCapability }[] = [
  ...
  { prefix: "/service-orders", capability: "SERVICE_ORDERS" },
  { prefix: "/clinical-services", capability: "CATALOG_CLINICAL" },
  { prefix: "/practitioners", capability: "PRACTITIONERS" },
